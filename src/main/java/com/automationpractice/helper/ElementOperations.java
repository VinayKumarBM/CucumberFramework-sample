...
public class ElementOperations {
	private static final Logger log = LoggerFactory.getLogger(ElementOperations.class);
	private Long waitTime = Long.parseLong(GetConfig.getConfigProperty("webdriverWaitTime"));
